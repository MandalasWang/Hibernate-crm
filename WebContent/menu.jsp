									...
									<TD>
										<TABLE id=table_1 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												...
												<TR>
													<TD class=menuSmall><A class=style2
														href="${pageContext.request.contextPath }/Customer?method=getCustomerlist"
									...
									<TD>
										<TABLE id=table_2 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												...
												<TR>
													<TD class=menuSmall><A class=style2
														href="${pageContext.request.contextPath }/linkman?method=linkmanlist"
								...
								<TR>
									<TD>
										<TABLE id=table_5 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												<TR>
													<TD class=menuSmall><A class=style2 href="${pageContext.request.contextPath }/jsp/visitor/add.jsp"
														target=main>－新增客户拜访</A></TD>
												</TR>
												<TR>
													<TD class=menuSmall><A class=style2 href="${pageContext.request.contextPath }/Visotor?method=getvisitorlist"
								...
								<TR>
									<TD>
										<TABLE id=table_3 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												<TR>
													<TD class=menuSmall><A class=style2 href="${pageContext.request.contextPath }/Customer?method=getCustomerlist"
														target=main>－ 客户信息查询</A></TD>
												</TR>
												<TR>
													<TD class=menuSmall><A class=style2 href="${pageContext.request.contextPath }/linkman?method=linkmanlist"
								...
								<TR>
									<TD>
										<TABLE id=table_4 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												<TR>
													<TD class=menuSmall><A class=style2 href="${pageContext.request.contextPath }/Customer?method=countCustcom"
														target=main>－客户行业统计</A></TD>
												</TR>
												<TR>
													<TD class=menuSmall><A class=style2 href="${pageContext.request.contextPath }/Customer?method=countsource"
