											...
											<TBODY>
												...
												<c:forEach items="${linkMans }" var="linkman">
													<TR
														...
														<TD><a
															href="${pageContext.request.contextPath }/linkman?method=editlinkman&lkm_id=${linkman.lkm_id}">修改</a>
															&nbsp;&nbsp; <a
															href="${pageContext.request.contextPath }/linkman?method=deletelinkman&lkm_id=${linkman.lkm_id}">删除</a>
														</TD>
													</TR>
